...
func ToolDefinitions() []toolDef {
	return []toolDef{
		...
		{Name: "list_projects", Description: "🟡 COMMON | List all accessible projects."},
		...
		{Name: "find", Description: "🔴 ESSENTIAL | Hybrid memory + decision retrieval. Default agent discovery path; supports wider limits and token budgets. Lexical-only baseline via hyde:off, rerank:off."},
		{Name: "task", Description: "🔴 ESSENTIAL | Unified task management. Actions: list, get, create, start, complete, stop, progress, note, move."},
		{Name: "memory", Description: "🟡 COMMON | List (unranked browse) / get memory details, or generate skill memories from a goal."},
...
// ============================================================================
// Find (hybrid search) — the unified retrieval path (replaced `recall`)
// ============================================================================
